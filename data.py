...
# Ler o arquivo Excel
df = pd.read_excel('Planilha Geral - Índice Trilema Brasil -  Atualizada - (2018-2022) - final.xlsx', sheet_name='Trilema Energético')
...
def tratamento_equidade():
    df_equidade = pd.melt(
        ...
        value_vars=['Equidade 2018', 'Equidade 2019', 'Equidade 2020', 'Equidade 2021', 'Equidade 2022', 'Equidade 2023'],
        var_name='Dimensão',
        value_name='Escala'
    )
...
def tratamento_seguranca():
    df_seguranca = pd.melt(
        df,
        id_vars=['Região', 'Estado'],
        value_vars=['Segurança 2018', 'Segurança 2019', 'Segurança 2020', 'Segurança 2021', 'Segurança 2022', 'Segurança 2023'],
        var_name='Dimensão',
        value_name='Escala'
    )
...
def tratamento_ambiental():
    df_ambiental = pd.melt(
        df,
        id_vars=['Região', 'Estado'],
        value_vars=['Ambiental 2018', 'Ambiental 2019', 'Ambiental 2020', 'Ambiental 2021', 'Ambiental 2022','Ambiental 2023'],
        var_name='Dimensão',
        value_name='Escala'
    )
